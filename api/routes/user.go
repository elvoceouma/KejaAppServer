...
import (
	...
	"github.com/elvoceouma/KejaServerSide/domain/models"
	"github.com/elvoceouma/KejaServerSide/storage"
	...
	if facebookBody.Email != "" {
		...
		if !userExists {
			...
			user = models.User{
				...
				SocialLogin:    true,       // Boolean value indicating social login
				SocialProvider: "Facebook", // String value indicating the social provider
			}
